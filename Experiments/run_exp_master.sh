...
#         'name=mh05_orb_akz    seq=~/dataset/euroc/MH_05/cam0/data yaml=../Install/etc/orbslam2/Monocular/EuRoC.yaml exe=../Install/bin mode=euroc features=[ORB,AKAZE] times=MH05.txt'
#         'name=mh05_orb_bsk    seq=~/dataset/euroc/MH_05/cam0/data yaml=../Install/etc/orbslam2/Monocular/EuRoC.yaml exe=../Install/bin mode=euroc features=[ORB,BRISK] times=MH05.txt'
#         'name=mh05_orb_kaz    seq=~/dataset/euroc/MH_05/cam0/data yaml=../Install/etc/orbslam2/Monocular/EuRoC.yaml exe=../Install/bin mode=euroc features=[ORB,KAZE] times=MH05.txt'
#         'name=mh05_orb_sft    seq=~/dataset/euroc/MH_05/cam0/data yaml=../Install/etc/orbslam2/Monocular/EuRoC.yaml exe=../Install/bin mode=euroc features=[ORB,SIFT] times=MH05.txt'
#         'name=mh05_orb_spp    seq=~/dataset/euroc/MH_05/cam0/data yaml=../Install/etc/orbslam2/Monocular/EuRoC.yaml exe=../Install/bin mode=euroc features=[ORB,SuperPoint] times=MH05.txt'
#         'name=mh05_akz_bsk    seq=~/dataset/euroc/MH_05/cam0/data yaml=../Install/etc/orbslam2/Monocular/EuRoC.yaml exe=../Install/bin mode=euroc features=[AKAZE,BRISK] times=MH05.txt'
#         'name=mh05_akz_kaz    seq=~/dataset/euroc/MH_05/cam0/data yaml=../Install/etc/orbslam2/Monocular/EuRoC.yaml exe=../Install/bin mode=euroc features=[AKAZE,KAZE] times=MH05.txt'
#         'name=mh05_akz_sft    seq=~/dataset/euroc/MH_05/cam0/data yaml=../Install/etc/orbslam2/Monocular/EuRoC.yaml exe=../Install/bin mode=euroc features=[AKAZE,SIFT] times=MH05.txt'
#         'name=mh05_akz_spp    seq=~/dataset/euroc/MH_05/cam0/data yaml=../Install/etc/orbslam2/Monocular/EuRoC.yaml exe=../Install/bin mode=euroc features=[AKAZE,SuperPoint] times=MH05.txt'
#         'name=mh05_bsk_kaz    seq=~/dataset/euroc/MH_05/cam0/data yaml=../Install/etc/orbslam2/Monocular/EuRoC.yaml exe=../Install/bin mode=euroc features=[BRISK,KAZE] times=MH05.txt'
#         'name=mh05_bsk_sft    seq=~/dataset/euroc/MH_05/cam0/data yaml=../Install/etc/orbslam2/Monocular/EuRoC.yaml exe=../Install/bin mode=euroc features=[BRISK,SIFT] times=MH05.txt'
#         'name=mh05_bsk_spp    seq=~/dataset/euroc/MH_05/cam0/data yaml=../Install/etc/orbslam2/Monocular/EuRoC.yaml exe=../Install/bin mode=euroc features=[BRISK,SuperPoint] times=MH05.txt'
#         'name=mh05_kaz_sft    seq=~/dataset/euroc/MH_05/cam0/data yaml=../Install/etc/orbslam2/Monocular/EuRoC.yaml exe=../Install/bin mode=euroc features=[KAZE,SIFT] times=MH05.txt'
#         'name=mh05_kaz_spp    seq=~/dataset/euroc/MH_05/cam0/data yaml=../Install/etc/orbslam2/Monocular/EuRoC.yaml exe=../Install/bin mode=euroc features=[KAZE,SuperPoint] times=MH05.txt'
#         'name=mh05_sft_spp    seq=~/dataset/euroc/MH_05/cam0/data yaml=../Install/etc/orbslam2/Monocular/EuRoC.yaml exe=../Install/bin mode=euroc features=[SIFT,SuperPoint] times=MH05.txt'
